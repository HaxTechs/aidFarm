    ...
    >
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex-shrink-0">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-amber-400 rounded-full border-2 border-background dark:border-background" />
              </div>
          ...
          {/* Right: Dark Mode Toggle + CTA Buttons with padding */}
            ...
            <div className="hidden md:flex items-center gap-2.5">
              ...
              {isMounted && (
                <Button
                  ...
                  size="icon"
                  onClick={toggleDark}
                  className="bg-muted hover:bg-muted/80 text-foreground transition-all duration-200"
                ...
                >
                  <div className="relative w-5 h-5 flex items-center justify-center">
                    ...
                    <Moon
                      className={`absolute size-5 transition-all duration-300 ${
                        isDark ? 'opacity-100 -rotate-90 scale-100' : 'opacity-0 rotate-90 scale-0'
                      }`}
                    />
                  </div>
                </Button>
                  ...
                  <nav className="flex flex-col gap-1 py-6">
                    {[
                      ...
                      <SheetClose asChild key={item.href}>
                        <Link 
                          href={item.href} 
                          className="px-4 py-3 rounded-lg text-base font-medium text-foreground hover:bg-primary/5 hover:text-primary transition-colors"
                        >
                          {item.label}
                        </Link>
                      </SheetClose>
