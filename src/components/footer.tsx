          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-white">AidFarm</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition-all shadow-md hover:shadow-lg"
                  >
